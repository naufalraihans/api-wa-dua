...
<body>
  <div class="card">
    ...
    <div id="content">
      <div id="login-form">
        <input type="text" id="phone" placeholder="Nomor HP (contoh: 081234567890)" />
    ...
    <ul class="endpoints">
      <li>Kirim: <code>POST /api/send-message</code></li>
      <li>Semua Pesan: <code>GET /api/messages</code></li>
      <li>Pesan Pribadi: <code>GET /api/messages/private</code></li>
      <li>Pesan Grup: <code>GET /api/messages/group</code></li>
      <li>Per Nomor: <code>GET /api/messages/:number</code></li>
